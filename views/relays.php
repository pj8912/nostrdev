...
<div class="container mt-5">
    <div style="border: 1px solid #eee; padding:10px">
        ...
        <input type="text" id="relay-input" class="form-control w-50" placeholder="Add Relay"><br>
        <button onclick="addRelay()" class="btn btn-success">Add Relay</button>
        <br>
        <ul id="relays" style="list-style: none;"></ul>
    </div>
</div>
<script>
